...
from core_models import SegmenthorViz
...
if __name__ == "__main__":
    ...
    parser = SegmenthorViz.add_model_specific_args(parser)
    ...
    model = SegmenthorViz.load_from_checkpoint(args.pretrained_ckpt, args = args, dataset_info = dataset_info)
    trainer.validate(model)
    trainer.predict(model, dataloaders = model.val_dataloader())
